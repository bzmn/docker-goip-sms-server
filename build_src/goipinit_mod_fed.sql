...
CREATE TABLE `crowd` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/crowd' AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/goip' DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/goip_group'  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
SET character_set_client = @saved_cs_client;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/groups' AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `message` (
  ...
  KEY `card_id` (`card_id`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/message' DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `prov` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/prov' AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `receiver` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/receiver' AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/recvgroup' DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/refcrowd' DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/refgroup' DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/sends' DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/system' DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/user' AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE IF NOT EXISTS `receive` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/receive' DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `record` (
  ...
  KEY `expiry` (`expiry`),
  KEY `goipid` (`goipid`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/record' DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `USSD` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/USSD' DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/auto' DEFAULT CHARSET=utf8;
...
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/auto_ussd'  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `recharge_card` (
  ...
  KEY `prov_id` (`prov_id`),
  KEY `goipid` (`goipid`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/recharge_card'  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `imei_db` (
  ...
  KEY `goipid` (`goipid`),
  KEY `imei` (`imei`)
) ENGINE=FEDERATED CONNECTION='mysql://ChangeItMYSQL_MAIN_LOGIN:ChangeItMYSQL_MAIN_PASSWORD@ChangeItMYSQL_MAIN_HOST:ChangeItMYSQL_MAIN_PORT/ChangeItMYSQL_MAIN_DB/imei_db'  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
